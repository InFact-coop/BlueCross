        ...
        div [ class "ma3" ]
            ...
            , div [ class "flex items-center" ]
                [ img [ src "./assets/cat.svg", class "mr3" ]
                    []
                , input [ id "myRange", type_ "range", value catValue, class "w-75 h-custom bg-blue input-reset br4 slider", rangeNumberToCss catValue, onInputValue UpdateCatsSlider ]
                    []
                ]
            , div
            ...
            , div [ class " flex items-center" ]
                ...
                , input [ id "myRange", type_ "range", rangeNumberToCss childrenValue, value childrenValue, class "w-75 h-custom bg-blue input-reset br4 slider", onInputValue UpdateChildrenSlider ]
                    []
                ]
            , div
                [ class "flex justify-around mb5" ]
            ...
            , div [ class " flex items-center" ]
                ...
                , input [ id "myRange", type_ "range", value peopleValue, class "w-75 h-custom bg-blue input-reset br4 slider", rangeNumberToCss peopleValue, onInputValue UpdatePeopleSlider ]
                    []
                ]
            , div
                [ class "flex justify-around mb5" ]
