...
ownerInfo model =
    div [ class "w-60-ns center ma3 " ]
        ...
        , div []
            [ input [ type_ "text", class "bg-light-blue w-80 w-50-ns w-50-ns br2 pa3 gray bn" ]
                []
            ]
        , div [ class "blue b mb2 mt4" ] [ text "What is your daytime telephone number?" ]
        , div []
            [ input [ type_ "text", class "bg-light-blue w-80 w-50-ns br2 pa3 gray bn" ]
                []
            ]
        ...
        , div
            ...
            [ input [ class "dn ", id "am", name "time", type_ "radio", value "am" ]
                []
        ...
        , div
            [ class "w-25-l w-50 tc mb2 flex flex-column inline-flex flex-wrap center" ]
            [ input [ class "dn ", id "pm", name "time", type_ "radio", value "pm" ]
                []
