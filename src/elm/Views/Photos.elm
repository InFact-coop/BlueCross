...
photos model =
    ...
    in
        div [ class "w-60-ns w-90 center ma3 mw8 " ]
            [ header [ class "b blue f4 lh-copy" ] [ text <| "Potential owners will want to see what " ++ getPetName model ++ " looks like. Please take or upload a great photo of " ++ pronounConverter "them!" model.dogGender ]
            , section []
                [ p [ class "fw1" ]
            ...
            , div [ class "flex flex-wrap justify-center" ]
                [ div [ class "ba w-40-ns w-80 vh-30  br2 b--blue ma3 mw5 grow" ]
                    [ div [ class "h-100" ]
                ...
                , div [ class "ba w-40-ns w-80 vh-30 br2 b--blue ma3 dn db-ns mw5 grow" ]
