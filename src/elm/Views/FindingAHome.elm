...
findingAHome model =
    div [ class "w-60-ns w-90 center" ]
        ...
        , div
            [ class "mt5 tc w-100" ]
            [ a [ classes [ "link w-25-ns w-100 bg-navy br2 white pa3 br2 f4 dib", ifThenElse (model.nextClickable == True) "" "bg-gray disableButton o-30" ], href "#owner-info" ] [ text "Next" ]
            ]
        ]
