            ...
            [ div [ class "background-dog cover db" ]
                [ div [ class "background-overlay aspect-ratio--object" ]
                    [ div [ class "w-50-ns w-90 center" ]
                        ...
                        , p [ class "white f4 tc pt3" ] [ text <| "Thank-you for answering our questions, this will help us find " ++ getPetName model ++ " a great new home.  " ]
                        ...
                        , div [ class "flex justify-center pt4" ]
                            [ a [ href "https://www.bluecross.org.uk/donate" ]
                                [ button [ class "hover-transition white ba b--white br2 bg-transparent ph3 pv2 hover-bg-white hover-dark-blue ma2 f4 pointer" ] [ text "Donate" ]
                                ]
                            , a [ href "https://www.bluecross.org.uk/" ]
                                [ button [ class "hover-transition white ba b--white br2 bg-transparent ph3 pv2 hover-bg-white hover-dark-blue ma2 f4 pointer" ] [ text "Back to Blue Cross Site" ]
                                ]
                            ]
                        ]
                    ]
