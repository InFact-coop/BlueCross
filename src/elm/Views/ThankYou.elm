                    ...
                    [ div [ class "w-50-ns w-90 center" ]
                        ...
                        , div [ class "flex justify-center pt4" ]
                            [ a [ href "https://www.bluecross.org.uk/donate" ]
                                [ button [ class "hover-transition white ba b--white br2 bg-transparent ph3 pv2 hover-bg-white hover-dark-blue ma2 f4" ] [ text "Donate" ]
                                ]
                            , a [ href "https://www.bluecross.org.uk/" ]
                                [ button [ class "hover-transition white ba b--white br2 bg-transparent ph3 pv2 hover-bg-white hover-dark-blue ma2 f4" ] [ text "Back to Blue Cross Site" ]
                                ]
                            ]
                        ]
                    ]
